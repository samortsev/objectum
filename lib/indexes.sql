create unique index _schema_id on <%=schema%>_schema (_id) <%=tablespace%>;
...
create index _revision_schema_id on <%=schema%>_revision (_schema_id) <%=tablespace%>;
...
create index _class_schema_id on <%=schema%>_class (_schema_id) <%=tablespace%>;
...
create index _class_attr_schema_id on <%=schema%>_class_attr (_schema_id) <%=tablespace%>;
...
create index _object_schema_id on <%=schema%>_object (_schema_id) <%=tablespace%>;
...
create index _object_attr_schema_id on <%=schema%>_object_attr (_schema_id) <%=tablespace%>;
...
create index _view_schema_id on <%=schema%>_view (_schema_id) <%=tablespace%>;
create index _view_record_id on <%=schema%>_view (_record_id) <%=tablespace%>;

create index _query_id on <%=schema%>_view (_id) <%=tablespace%>;
create index _query_name on <%=schema%>_view (_name);
create index _query_code on <%=schema%>_view (_code);
create index _query_parent_id on <%=schema%>_view (_parent_id) <%=tablespace%>;
create index _query_start_id on <%=schema%>_view (_start_id) <%=tablespace%>;
create index _query_end_id on <%=schema%>_view (_end_id) <%=tablespace%>;
create index _query_schema_id on <%=schema%>_view (_schema_id) <%=tablespace%>;
create index _query_record_id on <%=schema%>_view (_record_id) <%=tablespace%>;

create index _query_attr_id on <%=schema%>_view_attr (_id) <%=tablespace%>;
create index _query_attr_code on <%=schema%>_view_attr (_code) <%=tablespace%>;
create index _query_attr_name on <%=schema%>_view_attr (_name) <%=tablespace%>;
create index _query_attr_view_id on <%=schema%>_view_attr (_view_id) <%=tablespace%>;
create index _query_attr_start_id on <%=schema%>_view_attr (_start_id) <%=tablespace%>;
create index _query_attr_end_id on <%=schema%>_view_attr (_end_id) <%=tablespace%>;
create index _query_attr_schema_id on <%=schema%>_view_attr (_schema_id) <%=tablespace%>;
create index _query_attr_record_id on <%=schema%>_view_attr (_record_id) <%=tablespace%>;
...
create index _action_schema_id on <%=schema%>_action (_schema_id) <%=tablespace%>;
