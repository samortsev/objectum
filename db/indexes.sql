...
create index _view_attr_id on $schema$_view_attr (_id) $tablespace$;
create index _view_attr_code on $schema$_view_attr (_code) $tablespace$;
create index _view_attr_name on $schema$_view_attr (_name) $tablespace$;
create index _view_attr_view_id on $schema$_view_attr (_view_id) $tablespace$;
create index _view_attr_start_id on $schema$_view_attr (_start_id) $tablespace$;
create index _view_attr_end_id on $schema$_view_attr (_end_id) $tablespace$;
create index _view_attr_schema_id on $schema$_view_attr (_schema_id) $tablespace$;
create index _view_attr_record_id on $schema$_view_attr (_record_id) $tablespace$;
...
create index -action_record_id on $schema$_action (_record_id) $tablespace$;
